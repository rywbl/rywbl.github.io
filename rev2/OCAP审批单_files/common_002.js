...
var WpsApi={
  ...
  handleResultBody: handleResultBody,
  closeWpsIfNoDocument: closeWpsIfNoDocument,
  activeTab: activeTab,
  showOATab: showOATab,
  getDemoTemplatePath: getDemoTemplatePath,
  getDemoSealPath: getDemoSealPath,
  pGetParamName: pGetParamName,
  pGetFileName: pGetFileName,
  StringToUint8Array: StringToUint8Array,
  DownloadFile: DownloadFile,
  UploadFile: UploadFile,
  NotifyToServer: NotifyToServer,
